...
mod tests {
    ...
    #[test]
    fn test_success_deposit_different_token() {
        ...
        const FIRST_DEPOSIT_AMOUNT_ATOM: u128 = 300 * 10u128.pow(TOKENS_DECIMALS);
        ...
        app.execute_contract(
            ...
            margin_positions_addr.clone(),
            &ExecuteMsg::Deposit {},
            &coins(FIRST_DEPOSIT_AMOUNT_ATOM, "atom"),
        )
        .unwrap();
        ...
        assert_eq!(user_deposited_balance.u128(), FIRST_DEPOSIT_AMOUNT_ATOM);
        ...
        assert_eq!(
            app.wrap()
                ...
                .amount
                .u128(),
            INIT_USER_BALANCE - FIRST_DEPOSIT_AMOUNT_ATOM
        );
        ...
        assert_eq!(
            app.wrap()
                ...
                .amount
                .u128(),
            RESERVE_AMOUNT + FIRST_DEPOSIT_AMOUNT_ATOM
        );
    }
}
