...
mod tests {
    ...
    fn test_get_user_deposited_usd() {
        ...
        assert!(get_liquidity_rate_atom.u128() >  769000000000000000); // ~0.769%
        assert!(get_liquidity_rate_eth.u128() > 208000000000000000); // ~0.208%
        assert!(user_deposited_usd.u128() > 40385600000000); // ~403856$ (~0,213% deposite APY)
    }
}
